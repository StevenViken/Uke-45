...
class Player(pygame.sprite.Sprite):
    ...
    # Pacman blir raskere når pacman spiser powerUp
    def move_right(self, powerUP):
        self.change_x = 3 + powerUP

    def move_left(self, powerUP):
        self.change_x = -3 - powerUP

    def move_up(self, powerUP):
        self.change_y = -3 - powerUP

    def move_down(self, powerUP):
        self.change_y = 3 + powerUP
